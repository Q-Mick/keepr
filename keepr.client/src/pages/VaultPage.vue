<template>
  <section v-if="account" id="vaultImageSection">
    ...
    <div class="relative mx-auto text-center w-[50%]">
      ...
      <button v-if="account.id == vault.creatorId" @click="deleteVault(vault?.id)" class="btn btn-error btn-xs rounded-full h-6 font-bold mx-auto my-1 cursor-pointer " title="Delete vaults">Delete Vault</button>
    </div>
