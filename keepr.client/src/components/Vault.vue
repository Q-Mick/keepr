...
<div v-if="vault?.isPrivate" class="absolute right-0 bottom-0 pr-2 pb-[3px]">
  <div title="Vault is private" class="w-6 rounded-full border border-black avatar-elevation flex justify-center items-center">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"  class="rounded-full bg-white w-6 h-6">
